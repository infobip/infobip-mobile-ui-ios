...
EXCLUDES_FILES="Alamofire.h Kingfisher.h SwiftTryCatch.h SwiftTryCatch.m .gitignore Package.swift"
# -------------------------------------------
...
# Build the find prune expression as an array (done once, reused per extension)
prune_expr=()
